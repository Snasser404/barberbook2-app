    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 bg-gray-50">
      <div className="card p-8 w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">We'll email you a 6-digit reset code</p>
        </div>
        ...
        {sent ? (
          <div className="text-center">
            <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-4 rounded-lg text-sm mb-4">
              ...
              <p>If <span className="font-medium">{email}</span> matches an account, we've sent a 6-digit reset code. It expires in 1 hour.</p>
              <p className="mt-2 text-xs">Check your spam folder if you don't see it.</p>
            </div>
            <button
            ...
            <Link to="/login" className="block text-sm text-gray-500 hover:underline">← Back to sign in</Link>
          </div>
        ) : (
